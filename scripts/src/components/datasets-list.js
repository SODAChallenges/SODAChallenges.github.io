...
export default class {
  constructor (opts) {
    ...
    const paramFilters = pick(opts.params, ['organization', 'category','challenge_category'])
    const attributeFilters = pick(opts.el.data(), ['organization', 'category','challenge_category'])
